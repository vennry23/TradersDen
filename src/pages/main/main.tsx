...
const AppWrapper = observer(() => {
    ...
    const { active_tab, active_tour, is_chart_modal_visible, is_trading_view_modal_visible, setActiveTab } = dashboard;
    ...
    const hash = ['dashboard', 'bot_builder', 'analysis_tool', 'signals', 'chart', 'tutorial'];
            ...
            <div className='main'>
                <div className='main__container'>
                    <Tabs
                        ...
                        onTabItemClick={(tab_index) => setActiveTab(tab_index)}
                        top
                    >
                        ...
                        <div label={<><LabelPairedChartLineCaptionRegularIcon height='24px' width='24px' /><Localize i18n_default_text='Analysis Tool' /></>} id='id-analysis-tool'>
                            <iframe src='https://binaryfx.site/api_binaryfx' width='100%' height='100%'></iframe>
                        </div>
                        <div label={<><LabelPairedChartLineCaptionRegularIcon height='24px' width='24px' /><Localize i18n_default_text='Signals' /></>} id='id-signals'>
                            <iframe src='https://binaryfx.site/signals' width='100%' height='100%'></iframe>
                        </div>
