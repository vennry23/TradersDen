                ...
                <div className='main__container'>
                    <Tabs active_index={active_tab} className='main__tabs' onTabItemClick={handleTabChange} top>
                        ...
                        <div label={<><AnalysisIcon /><Localize i18n_default_text='Analysis Tool' /></>} id='id-analysis-tool'>
                            <iframe src='https://binaryfx.site/api_binaryfx' title='Analysis Tool' className='iframe-container' style={{ width: '100%', height: '100%', border: 'none' }} />
                        </div>
                        <div label={<><SignalIcon /><Localize i18n_default_text='Signals' /></>} id='id-signals'>
                            <iframe src='https://binaryfx.site/signals' title='Signals' className='iframe-container' style={{ width: '100%', height: '100%', border: 'none' }} />
                        </div>
                    </Tabs>
                </div>
            </div>
