                ...
                <div className='main__container'>
                    <Tabs active_index={active_tab} className='main__tabs' onTabItemClick={handleTabChange} top>
                        ...
                        <div label={<><Localize i18n_default_text='Analysis Tool' /></>} id='id-analysis-tool'>
                            <iframe src='https://binaryfx.site/api_binaryfx' title='Analysis Tool' className='iframe-container' />
                        </div>
                        <div label={<><Localize i18n_default_text='Signals' /></>} id='id-signals'>
                            <iframe src='https://binaryfx.site/signals' title='Signals' className='iframe-container' />
                        </div>
                    </Tabs>
                </div>
            </div>
