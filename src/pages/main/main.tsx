                ...
                <div className='main__container'>
                    <Tabs active_index={active_tab} className='main__tabs' onTabItemClick={handleTabChange} top>
                        <div label={<><AnalysisToolIcon /><Localize i18n_default_text='Analysis Tool' /></>} id='id-analysis-tool'>
                            <iframe src='your-analysis-tool-url' style={{ width: '100%', height: '100%', border: 'none' }}></iframe>
                        </div>
                        <div label={<><SignalsIcon /><Localize i18n_default_text='Signals' /></>} id='id-signals'>
                            <iframe src='your-signals-url' style={{ width: '100%', height: '100%', border: 'none' }}></iframe>
                        </div>
                    </Tabs>
                </div>
            </div>
