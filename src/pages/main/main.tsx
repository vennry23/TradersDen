    ...
    useEffect(() => {
        ...
        const fetchBots = async () => {
            const botFiles = [
                ...
                '7-UP-DIGIT-BOT.XML.xml',
                'BEAR-MARKET-AUTO-BOT-TRADER.XML',
                'binary-bot Premium Rise_Fall .xml',
                'BULL-MARKET-AUTO-BOT TRADER.XML',
                'Defender_Digits Auto Bot.xml',
                'Digit Over 3.xml',
                'DIGIT-OVER COMPOUNDER STRATEGY BOT.xml',
                'Digit-Ranger-Auto-Bot.xml',
                'Dynamic_Digits-Auto-Bot.xml',
